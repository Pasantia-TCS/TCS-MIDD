...
public class RecursosPerfil {
	...
	public ResponseEntity<?> actualizarRol(@RequestBody Perfil perfil) {
		...
		return new ResponseEntity<>(respuestas.respuestas(
				"El usuario con ultimatix: " + perfil.getId_ultimatix() + " cambio de rol ", "200"), HttpStatus.OK);
	}
	...
	// METOD PARA AGREGAR UNA HABILIDAD
	...
	// METODO PARA AGREGAR UN AHABILIDAD FUNCIONAL
	...
	// METODO PARA ELIMINAR UNA HABILIDAD FUNCIONAL
	...
	// METODO PARA AGREGAR UNA APLICACION
	...
	// METODO PARA ELIMINAR UNA PALICACION
